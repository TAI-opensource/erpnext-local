...
function generateSeedData(): Record<string, unknown[]> {
  ...
  return {
    ...
    project: [
      { name: 'PRJ-2026-00001', project_name: 'Website Redesign', company: '_Test Company', status: 'Working', percent_complete: 35, start_date: '2026-07-01', end_date: '2026-09-30', creation: now, modified: now },
      { name: 'PRJ-2026-00002', project_name: 'Mobile App Development', company: '_Test Company', status: 'Draft', percent_complete: 0, start_date: '2026-07-15', end_date: '2026-12-31', creation: now, modified: now },
    ],
    task: [
